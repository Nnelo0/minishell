...
/*   Updated: 2025/03/06 09:00:37 by ebroudic         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	command_utils(t_shell *shell)
{
	if (shell->input)
	{
		...
		shell->status = which_commands(shell->input, shell);
		if (shell->save_in != -1)
		{
